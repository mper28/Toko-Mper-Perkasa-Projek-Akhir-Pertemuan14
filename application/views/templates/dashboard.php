...
<head>    
    ...
    <title><?= $title; ?> | Aplikasi Pengadaan Transaksi dan laporan Barang Di Toko Mper Perkasa</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">Toko Mper Perkasa</div>
            </a>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy;Aplikasi Pengadaan Barang, Toko Mper Perkasa; by Mahasiswa Universitas Catur Insan Cendekia Cirebon<?= anchor('https://www.instagram.com/per_1211/'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
